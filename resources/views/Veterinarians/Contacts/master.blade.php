...
<nav class="sidebar-nav">
        <ul id="sidebarnav">
          ...
          <li class="nav-small-cap mt-3"> Records</li>
             ...
             <li class="nav-small-cap mt-3"> User Records</li>
                <li class="sidebar-item">
            <a class="sidebar-link text-white" href="{{route('admin.users.index')}}"><i data-feather="users" class="me-2"></i> Users Information</a>
             
          </li>
         <li class="sidebar-item">
    <a class="sidebar-link" href="{{ route('admin.contacts.index') }}">
        <i data-feather="database" class="me-2"></i> Contact Records
    </a>
</li>
 <li class="nav-small-cap mt-3"> User Blogs </li>
   <li class="sidebar-item">
 
  <a class="sidebar-link" href="{{ route('admin.blogs.index') }}">
      <i data-feather="file-text" class="me-2 text-white"></i> ADD Blog Records
  </a>
</li>

        
         <li class="sidebar-item">
    <a class="sidebar-link" href="{{ route('admin.statistics.index') }}">
